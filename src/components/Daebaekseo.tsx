...
const RECIPES: Recipe[] = [
  ...
  {
    ico: "🏪", goal: "내 매장을 진단하고 지역 업체·블로거를 찾을 때", when: "플레이스 360에서 내 매장을 점검하고 업체를 발굴해 블로거까지 역추적할 때",
    accent: "#16856b",
    steps: [
      { tab: "플레이스 360", title: "① 내 매장 진단", desc: "매장을 등록하고 신규 고객·노출·리뷰·재방문·광고·상권 상태를 순서대로 확인해요." },
      { tab: "플레이스 360", title: "② 업체·리뷰어 찾기", desc: "지역 업체를 발굴하고 그 업체를 리뷰한 블로거까지 역추적해요." },
