...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    accent: "#16856b",
    steps: [
      { tab: "플레이스 360 · 시작", title: "① 내 매장 등록·전환", desc: "상호명·지역·업종을 입력해요. 무료 1개·베이직 2개·프로 5개까지 등록하고, 위쪽 매장 버튼으로 순위와 진단 화면을 바꿀 수 있어요." },
      ...
      { tab: "오늘 할 일", title: "⑤ 성장 미션을 순서대로 실행", desc: "내 매장 수치에 맞춰 오늘 해야 할 일을 1·2·3 순서로 보여줘요. 끝난 작업은 완료 체크할 수 있어요." },
