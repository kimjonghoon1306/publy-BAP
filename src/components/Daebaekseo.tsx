...
export const DAEBAEKSEO_VERSION = 3;   // 내용 크게 바뀌면 +1 → 로그인 자동팝업 다시 노출
...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    accent: "#16856b",
    steps: [
      { tab: "플레이스 360 · 시작", title: "① 내 매장 등록", desc: "상호명·지역·업종을 입력해요. 네이버 플레이스 주소까지 넣으면 내 매장을 더 정확하게 찾을 수 있어요." },
      { tab: "지금 내 순위", title: "② 지역·업종 검색 순위 확인", desc: "고객이 검색하는 키워드로 내 매장이 몇 위인지 측정하고, 지난 측정과 비교해 상승·하락을 확인해요." },
    ...
    tip: "순위는 위치·시간·기기에 따라 달라질 수 있어요. 같은 키워드를 같은 조건으로 꾸준히 측정해야 진짜 상승 흐름이 보여요. 고객 화면에서 부족한 정보부터 고친 뒤 다시 확인하세요.",
  },
  {
