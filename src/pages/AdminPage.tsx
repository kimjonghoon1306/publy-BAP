          ...
          <div className="main">
            ...
            {tab === "photo" && (
              <div className="photo-root">
                ...
                <div className="card" style={{padding:"18px",marginBottom:14}}>
                  <label className="inp-label">✏️ 키포인트 <span style={{fontSize:11,color:"var(--text3)"}}>(선택사항)</span></label>
