  ...
  function renderSaBadge(){
    ...
    return (
      <div onClick={()=>setTab("accounts")} title="서치어드바이저 자동 색인요청 설정으로 이동"
        style={{cursor:"pointer",margin:"12px 0",padding:"11px 14px",borderRadius:12,border:`1.5px solid ${saAuto?"#ff2d78":"var(--border)"}`,background:saAuto?"rgba(255,45,120,.06)":"var(--card2)",display:"flex",alignItems:"center",gap:10}}>
