              ...
              <div className="photo-root">
                ...
                <div className="card" style={{padding:"18px",marginBottom:14}}>
                  <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
                    ...
                    <button onClick={()=>{const html=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>키포인트 예시</title><style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Malgun Gothic',sans-serif;background:#fdf0ff;color:#111}h1{background:linear-gradient(135deg,#FF6B9D,#C77DFF);color:#fff;padding:20px 24px;font-size:18px}.content{padding:20px}.intro{font-size:14px;color:#555;line-height:1.8;margin-bottom:18px;padding:12px 16px;background:#fff;border-radius:12px;border-left:4px solid #C77DFF}.cat-title{font-size:13px;font-weight:800;color:#FF6B9D;margin:14px 0 8px;padding:4px 10px;background:#FF6B9D11;border-radius:6px;display:inline-block}.bad{background:#fff0f0;border:1px solid #ffcccc;border-radius:10px;padding:10px 14px;margin-bottom:6px;font-size:13px;color:#c00;line-height:1.7}.good{background:#f0fff4;border:1px solid #99ddaa;border-radius:10px;padding:10px 14px;font-size:13px;color:#005c1a;line-height:1.8;margin-bottom:14px}.lbl{font-size:10px;font-weight:800;margin-bottom:3px}.tip{background:linear-gradient(135deg,#FF6B9D11,#C77DFF11);border:1px solid #C77DFF33;border-radius:12px;padding:14px;margin-top:4px;font-size:13px;line-height:1.9}</style></head><body><h1>✏️ 키포인트 이렇게 쓰면 좋아요</h1><div class="content"><div class="intro">구체적으로 쓸수록 실제 경험처럼 자연스러운 글이 나옵니다.</div><div class="cat-title">🍽️ 맛집</div><div class="bad"><div class="lbl">❌ 아쉬운 예</div>강원도 맛집, 고기집</div><div class="good"><div class="lbl">✅ 좋은 예</div>강원도 홍천 태장동 / 한우 소갈비찜 / 2인 45,000원 / 웨이팅 40분 / 주차 무료 / 재방문 의향 있음</div><div class="cat-title">✈️ 여행</div><div class="bad"><div class="lbl">❌ 아쉬운 예</div>제주도 여행, 좋았다</div><div class="good"><div class="lbl">✅ 좋은 예</div>제주 성산읍 성산일출봉 / 오전 6시 방문 / 입장료 5,000원 / 공항에서 1시간</div><div class="cat-title">☕ 카페</div><div class="bad"><div class="lbl">❌ 아쉬운 예</div>서울 카페, 예뻤다</div><div class="good"><div class="lbl">✅ 좋은 예</div>서울 성수동 공장 리모델링 카페 / 아메리카노 6,500원 / 대기 없음 / 지하철 권장</div><div class="cat-title">📦 제품</div><div class="bad"><div class="lbl">❌ 아쉬운 예</div>에어프라이어 구매</div><div class="good"><div class="lbl">✅ 좋은 예</div>필립스 에어프라이어 5.6L / 129,000원 / 6개월 사용 / 만족도 9점</div><div class="tip">💡 장소 + 가격 + 시간 + 특징 + 내 의견 = 훨씬 풍부한 글!</div></div></body></html>`;if((window as any).electron?.openPreview){(window as any).electron.openPreview(html);}else{const w=window.open("","_blank","width=540,height=800");if(w){w.document.write(html);w.document.close();}}}} style={{padding:"5px 12px",borderRadius:20,background:"linear-gradient(135deg,#FF6B9D,#C77DFF)",color:"#fff",border:"none",cursor:"pointer",fontSize:11,fontWeight:800,fontFamily:"inherit",whiteSpace:"nowrap",flexShrink:0}}>📝 예시 보기</button>
                  </div>
                    ...
                    <div className="card" style={{padding:0,overflow:"hidden"}}>
                      ...
                      {showMeta&&(
                        <div style={{padding:"0 16px 16px",borderTop:"1px solid var(--border)",display:"flex",flexDirection:"column",gap:14,marginTop:4,paddingTop:16}}>
                          ...
                          <div>
                            <label className="inp-label">💬 인사말 <span style={{fontWeight:400,color:"var(--text3)"}}>(선택)</span></label>
